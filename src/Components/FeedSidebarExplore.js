...
const FeedSidebarExplore = ({
  ...
  // const LikeButtn = () => {
  //   // console.table(' \n', [
  //   //   { 'Is Like': item.is_like, 'like Count': item.likes_count },
  //   // ]);
  //   // likeCOlor === '#5E72E4' ? setlikeCOlor('#fff') : setlikeCOlor('#5E72E4');

  //   item['likes_count'] = item.is_like
  //     ? item?.likes_count - 1
  //     : item?.likes_count + 1;
  //   item['is_like'] = item['is_like'] == true ? false : true;
        ...
        <View style={styles.sidebarContentWrapper}>
          ...
          >
            <View style={[styles.sidebarIconWrapper, { marginTop: 33 }]}>
              ...
              <Text style={[styles.sidebarTextStyle, { height: 17 }]}>
...
export default React.memo(FeedSidebarExplore);
