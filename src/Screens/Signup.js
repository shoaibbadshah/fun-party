  ...
  return (
    <KeyboardAwareScrollView
      ...
      <View>
        ...
        <View
          ...
          <View
            ...
            <TextInput
              ...
              style={[[styles.textInput, {color: 'white', fontWeight: 'bold'}]]}
            />
          </View>
        ...
        <View style={[styles.textInputView, {width: '100%', display: 'none'}]}>
          {/* <Email /> */}
          <TextInput
            placeholderTextColor="#B7B7B7"
        ...
        <View
          ...
          <TouchableOpacity
            ...
            <Text style={{color: '#5E72E4', fontWeight: 'bold', marginTop: -7}}>
              Terms & Conditions{' '}
            </Text>
          </TouchableOpacity>
